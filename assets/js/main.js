...
new Chart(document.getElementById('chartDB'), {
    type: 'pie',
    data: {
        labels: ['ETL Concepts', 'Data Modeling', 'Data Quality', 'Cloud SQL', 'BigQuery/Looker'],
        datasets: [{
            data: [80, 78, 83, 85, 75],
            backgroundColor: [
                'hsla(350, 80%, 65%, 0.85)',   // rose-red
                'hsla(25,  85%, 62%, 0.85)',    // orange
                'hsla(48,  90%, 60%, 0.85)',    // yellow
                'hsla(160, 70%, 55%, 0.85)',    // teal-green
                'hsla(210, 75%, 62%, 0.85)',    // blue
            ],
            borderColor: [
                'hsla(350, 80%, 65%, 1)',
                'hsla(25,  85%, 62%, 1)',
